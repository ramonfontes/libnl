...
class station(nl80211_managed_object):
	...
	def put_obj_id(self, msg):
		...
		nla_put_u32(msg, nl80211.STA_INFO_SIGNAL, 10)
		nla_put_u32(msg, nl80211.ATTR_IFINDEX, self._ifidx)
		nla_put(msg, nl80211.ATTR_MAC, self._mac)
...
class station_list(custom_handler):
	def __init__(self, ifidx, access=None, kind=NL_CB_DEFAULT):
		...
		nla_put_u32(n._msg, nl80211.ATTR_IFINDEX, ifidx)
		self._access = access
		access.send(m, self)
